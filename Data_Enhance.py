...
img_path = r'D:\LJ\lj_SOTA_Transfomer\HTCNet\AerialImageDataset\train_post\mask'           #输入和输出影像所在文件夹
...
def create_read_img(filename):
    ...
    # image_brightened.save(filename[:-4] + '_brighter.png')
    #
    # # 色度增强
    # enh_col = ImageEnhance.Color(im)
    # color = 1.5
    # image_colored = enh_col.enhance(color)
    # image_colored.save(filename[:-4] + '_color.png')
    #
    # # 对比度增强
